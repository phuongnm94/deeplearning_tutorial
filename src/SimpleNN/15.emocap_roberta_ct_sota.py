...
class BatchPreprocessor(object): 
    ...
    def __call__(self, batch):
        ...
        return (contextual_sentences_ids, torch.LongTensor(labels), padding_utterance_masked, cur_sentence_indexes_masked, raw_sentences) 
...
class EmotionClassifier(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx, return_y_hat=False):
        input_ids, labels, padding_utterance_masked, cur_sentence_indexes_masked, raw_sentences = batch
    ...
    def validation_step(self, batch, batch_idx):
        v_multi_conversation, labels, padding_utterance_masked, cur_sentence_indexes_masked, raw_sentences = batch

...
class EmotionClassifier(pl.LightningModule):
    def __init__(
        ...
        self.context_modeling = None # using transformer model in here 
        self.pos_encoding = None # position encoding => for utterance positions (e.g., u_1, u_2, ...) in conversation. 
        ...
        self.loss_computation = torch.nn.CrossEntropyLoss(ignore_index=-1, label_smoothing=0.1)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--batch_size", help="batch ", type=int, default=2)
    ...
    # test
    trainer.test(model, valid_loader, ckpt_path=checkpoint_callback.best_model_path)

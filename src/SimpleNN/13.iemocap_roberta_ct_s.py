...
class BatchPreprocessor(object): 
    ...
    def __call__(self, batch):
        ...
        return (contextual_sentences_ids, torch.LongTensor(labels), padding_utterance_masked, torch.BoolTensor(intra_speaker_masekd),  raw_sentences) 
